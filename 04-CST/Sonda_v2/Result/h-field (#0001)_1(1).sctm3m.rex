...
<MetaResultFile version="20200629" creator="FD-Control">
  ...
  <SimulationProperties fieldname="surface current (f=7.55) [1]" fieldtype="Surface current" frequency="7.5499999999999998" encoded_unit="&amp;U:A^1.:m^-1" fieldscaling="PEAK" dB_Amplitude="20"/>
